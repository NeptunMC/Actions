...
public final class Titles {
  ...
  private static Constructor<?> getPacketPlayOutTitleConstructor() {
    try {
      ...
      throw new RuntimeException(
          String.format(
              "Failed to retrieve Constructor from '%s' Class on version '%s'",
              "PacketPlayOutTitle", Reflection.VERSION));
    }
  }
  ...
  private static Constructor<?> getPacketPlayOutChatConstructor() {
    try {
      return Reflection.getNMSClass("PacketPlayOutChat")
          .getConstructor(PACKET_PLAY_OUT_CHAT_CLASS, I_CHAT_BASE_COMPONENT_CLASS, Byte.class);
    } catch (final NoSuchMethodException ex) {
      throw new RuntimeException(
          String.format(
              "Failed to retrieve Constructor from '%s' Class on version '%s'",
              "PacketPlayOutChat", Reflection.VERSION));
    }
  }

  private static Method getChatSerializerMethod() {
    try {
      return Reflection.getNMSClass("IChatBaseComponent\\$ChatSerializer")
          .getMethod("a", String.class);
    } catch (final NoSuchMethodException ex) {
      throw new RuntimeException(
          String.format(
              "Failed to retrieve '%s' Method from '%s' Class on version '%s'",
              "a", "IChatBaseComponent\\$ChatSerializer", Reflection.VERSION));
    }
  }
  ...
  private static Method getHandleMethod() {
    try {
      ...
      throw new RuntimeException(
          String.format(
              "Failed to retrieve '%s' Method from '%s' Class on version '%s'",
              "getHandle", "entity.CraftPlayer", Reflection.VERSION));
    }
  }
  ...
  private static Method getSendPacketMethod() {
    try {
      ...
      throw new RuntimeException(
          String.format(
              "Failed to retrieve '%s' Method from '%s' Class on version '%s'",
              "sendPacket", "Packet", Reflection.VERSION));
    }
  }
  ...
  private static Field getPlayerConnectionField() {
    try {
      ...
      throw new RuntimeException(
          String.format(
              "Failed to retrieve '%s' Field from '%s' Class on version '%s'",
              "playerConnection", "EntityPlayer", Reflection.VERSION));
    }
  }
  ...
  private static Object getTitleEnum() {
    try {
      ...
      throw new RuntimeException(
          String.format(
              "Failed to retrieve '%s' Field from '%s' Class on version '%s'",
              "TITLE", "PacketPlayOutTitle\\$EnumTitleAction", Reflection.VERSION));
    }
  }
  ...
  private static Object getSubTitleEnum() {
    try {
      ...
      throw new RuntimeException(
          String.format(
              "Failed to retrieve '%s' Field from '%s' Class on version '%s'",
              "SUBTITLE", "PacketPlayOutTitle\\$EnumTitleAction", Reflection.VERSION));
    }
  }
  ...
  private static Object createIChatBaseComponent(final String text) {
    try {
      ...
      throw new RuntimeException(
          String.format(
              "Failed to invoke Text Method from '%s' Class on version '%s'",
              "IChatBaseComponent\\$ChatSerializer", Reflection.VERSION));
    }
  }
  ...
  public static void sendPlayerTitle(
      final Player player,
      final String title,
    ...
    try {
      ...
      final Object titlePacket =
          PACKET_PLAY_OUT_TITLE_CONSTRUCTOR.newInstance(
              TITLE_ENUM, titleBaseComponent, fadeIn, stay, fadeOut);

      sendPacket(player, titlePacket);
      if (subtitle != null) {
        final Object subTitleBaseComponent = createIChatBaseComponent(subtitle);
        final Object subTitlePacket =
            PACKET_PLAY_OUT_TITLE_CONSTRUCTOR.newInstance(
                SUB_TITLE_ENUM, subTitleBaseComponent, fadeIn, stay, fadeOut);
  ...
  public static void sendActionBarMessage(final Player player, final String message) {
    try {
      ...
      final Object actionBarPacket =
          PACKET_PLAY_OUT_CHAT_CONSTRUCTOR.newInstance(actionBarBaseComponent);
